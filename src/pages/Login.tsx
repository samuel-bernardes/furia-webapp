...
function Login() {
    ...
    return (
        <div className="min-h-screen bg-neutral-950 bg-cover bg-center" style={{ backgroundImage: `url(${loginWallpaper})` }}>
                    ...
                    <div className="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
                        <form action="#" method="POST" className="space-y-6">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="flex w-full justify-center rounded-md bg-yellow-500 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-yellow-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
                        ...
                        <p className="mt-10 text-center text-sm/6 text-gray-500">
                            Ainda não tem conta?{' '}
                            <span className="font-semibold cursor-pointer text-yellow-500 hover:text-yellow-400" onClick={() => navigate("/")}>
                                Registre-se
                            </span>
                        </p>
                    </div>
